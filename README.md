...
![GitHub](https://img.shields.io/github/release/neurogamedev/UE5_NeuroMaze?style=for-the-badge)
![GitHub](https://img.shields.io/github/license/neurogamedev/UE5_NeuroMaze?style=for-the-badge)

A proof of concept using Brain-Computer Interfaces as a main game mechanic in Unreal Engine 5.1.

![NeuroMazeLD](https://user-images.githubusercontent.com/88777150/230889822-3a7a3480-97a6-4dec-aebc-4331b287d0fa.gif)
...
- This project uses my old UE 5.0 [Neurogame Template](https://github.com/neurogamedev/NeurosityUE5-NeurogameTemplate/). The Upgrade to 5.1 was a bit painful on account of new Input Systems and new Character BPs. I am still cleaning things up, but the main gameplay works.

## To Do

- ReplaceNode.js plugin workarounds with proper Neurosity SDK... whenever if ever they support Unreal Engine.
